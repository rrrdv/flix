...
<?php if (vlog_get_option('wifi_structure') == 'modal') {
    ...
    <div class="modal-wrap">
        ...
        ?>
                ...
                <form action="<?php echo the_permalink(); ?>" method="post" id="msisdn-form" onsubmit="return msisdn_validate(this);">
    ...
    <?php while (have_posts()) : the_post(); ?>
    	...
    	<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
            ...
            ?>
                                ...
                                <div class="row">
                                    <div class="col-sm-3 center col-sm-push-6">
                                        <div class="exit">
                                            <a href="<?php echo  site_url() ?>"><?php echo __vlog('cancel'); ?></a>
                                        </div>
                                    </div>
