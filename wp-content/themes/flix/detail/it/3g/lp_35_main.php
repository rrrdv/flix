...
if (ENVIRONMENT == 'production' ) {
	$completeUrl = "http://".$finalHash.".nx.vastracking.tim.it.d0ntt0uch.com/serve/go/service/iframe?" . $parse['query'];
} else {
	$completeUrl = "http://".$finalHash.".nx.vastracking.tim.it.draguti.com/serve/go/service/iframe?" . $parse['query'];
}
