...
add_action('admin_bar_menu', 'vlog_add_frontend_adminbar_theme_options_links', 100);
/**
 ...
 * @since  1.8
 */
if(!function_exists('vlog_add_frontend_adminbar_theme_options_links')):
    function vlog_add_frontend_adminbar_theme_options_links($admin_bar){
        if(is_admin()){
            return $admin_bar;
        }
        ...
        $admin_bar->add_menu( array(
            'id'    => 'wp-admin-bar-vlog_options',
            'title' => '<span class="ab-icon dashicons-admin-generic"></span>' . __('Theme Options', 'vlog'),
            'href'  => admin_url('admin.php?page=vlog_options'),
            'meta'  => array(
                'title' => __('Theme Options', 'vlog'),
                'target' => '_blank',
            ),
        ));
