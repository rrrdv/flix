...
$args = array(
    'opt_name'             => $opt_name,
    'display_name'         => wp_kses( sprintf( __( 'Flix Options%sTheme Documentation%s', 'vlog' ), '<a href="https://confluence.bootecmarketing.com/display/vrt/1.+Service+setup+for+FLIX+Theme" target="_blank">', '</a>' ), wp_kses_allowed_html( 'post' )),
    'menu_type'            => 'menu',
    'allow_sub_menu'       => true,
    'menu_title'           => esc_html__( 'Theme Options', 'vlog' ),
    'page_title'           => esc_html__( 'Flix Options', 'vlog' ),
    'google_api_key'       => '',
